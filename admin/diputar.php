...
<header class="w3-container" style="padding-top:5px;padding-bottom: 10px;">
    <h3><b><i class="fa fa-film"></i> <span style="color: #206ce8;">Movie</span> > Diputar</b></h3>
</header>
<table id="konten">
	<tr>
		<td style="background-color: #79abfc;color: white;" height="50px"><h4 style="margin-left: 10px;"><b>Daftar Movie Yang Sedang Diputar</b></h4></td>
	</tr>
	<tr>
		<td><h5 style="margin-left: 10px;"><a class="btn btn-primary" href="?page=tambah_diputar"><i class="glyphicon glyphicon-plus"></i> Tambah Diputar</a></h5></td>
	</tr>
	<tr>
		<td>
		  <table id="example1" class="table table-striped" style="padding-top: 20px;margin-left: 10px;padding-bottom: 20px;width: 95%;">
		 	...
		 	<tbody>
		 	<?php foreach($Movie->diputar() as $d){ ?>
		 	<tr>
		 		...
		 		<td><a class="btn btn-danger" href="deletediputar.php?id_movie=<?php echo $d->id_movie; ?>"><i class=""></i><i class="glyphicon glyphicon-trash"></i> Hapus</a></td>
		 	</tr>
		 	<?php } ?>
		 	</tbody>
		 </table>
