...
$review = $Ratting->single2($id_movie);
...
<header class="w3-container" style="padding-top:5px;padding-bottom: 10px;">
    <h3><b><i class="fa fa-film"></i> <span style="color: #206ce8;">Movie</span> > <span style="color: #206ce8;">Review</span> > Lihat Review</b></h3>
</header>
<table id="konten">
	<tr>
	...
	<tr>
		<td>
		 <table id="example1" class="table table-striped" style="padding-top: 20px;margin-left: 10px;padding-bottom: 20px;width: 95%;">
		 	...
		 	<tbody>
		 		<?php while($d = $review->fetchObject()){$i++ ?>
		 		<tr>
		 			<td><?php echo $i; ?></td>
		 			<td><?php echo $d->username; ?></td>
		 			<td><?php echo $d->review; ?></td>
		 			<td><?php echo $d->jumlah; ?></td>
		 			<td><a onclick="return confirm('Anda Yakin Ingin Mendelete ?');" class="btn btn-danger" href="delete.php?page=review&id_rating=<?php echo $d->id_rating; ?>"><i class="glyphicon glyphicon-trash"></i> Delete</a></td>
		 		</tr>
		 		<?php } ?>
		 	</tbody>
		 </table>
