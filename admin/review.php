...
<header class="w3-container" style="padding-top:5px;padding-bottom: 10px;">
    <h3><b><i class="fa fa-film"></i> <span style="color: #206ce8;">Movie</span> > Review</b></h3>
</header>
<table id="konten">
	<tr>
			...
			<thead>
			 ...
			 <tbody>
			 	...
			 	<tr>
			 		...
			 		<td><a class="btn btn-primary" href="?page=lihat_review&id_movie=<?php echo $d->id_movie; ?>"><i class="glyphicon glyphicon-eye-open"></i> Lihat Review</a></td>
			 	</tr>
			 	<?php } ?>
			 </tbody>
			 </table>
