			...
			<div class="col-md-6">
				<div class="myMenu">
					<ul class="dropDownMenu">
						<li><a href="akandatang.php"><b>Movie</b></a>
							<ul>
								<li><a href="genre.php">Genre</a></li>
								<li><a href="diputar.php">Sedang Diputar</a></li>
								<li><a href="akandatang.php">Akan Datang</a></li>
								<li><a href="allceleb.php">Celebrity</a></li>
							</ul>
						</li>
						<li><a href="http://html-tuts.com/?p=9961"><b>Berita</b></a>
							<ul>
						...
						<li><a href="http://html-tuts.com/?p=9961"><b>Chart</b></a>
							<ul>
								<li><a href="chart/100filmindoterbaik.php">100 Film Indoneisa Terbaik</a></li>
								<li><a href="chart/100filmterbaik.php">100 Film Indoneisa Terbaik</a></li>
								<li><a href="http://html-tuts.com/?p=9961">JS</a></li>
							</ul>
						</li>
