...
<head>
    ...
    <link rel="stylesheet" href="plugin/megamenu/css/ionicons.min.css">    <!-- JS -->
    <script>
...
<body>
    ...
    <div class="menu-container">
        ...
        <a href="index2.php" style="text-decoration: none;"><b style="font-size: 25px;padding-top: 5px;margin-left: 40px;">XyzFilm</b></a>
        <input type="search" name="kata" placeholder="Cari..." id="cari" style="margin-left: 40px;">
        <button type="submit"><span class="glyphicon glyphicon-search"></span></button>
        </form>
            <ul>
                <li><a href="diputar.php"><b>Movies</b></a>
                    <ul>
                        <li><a href="diputar.php">Movies</a>
                            <ul>
                ...
                <li><a href="allceleb.php"><b>Celebrity</b></a>
                    <ul>
                        <li><a href="borntoday.php">Born Today</a></li>
                    </ul>
                </li>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Berita Pekan ini</a>
                            <ul>
                                ...
                                <label><a href="article.php?judul=<?php echo $d->slug; ?>"><?php echo substr($d->judul, 0,30); ?></a></label>
                                </li>
                            </ul>
                        </li>
                        <?php } ?>
                ...
                <li><a href=""><b>Chart</b></a>
                    <ul>
                        <li><a href="#">Chart</a>
                            <ul>
                                <li><a href="chart/100filmterbaik.php">100 FIlm Terbaik</a></li>
                                <li><a href="chart/100filmindoterbaik.php">100 Film Indonesia</a></li>
                                <li><a href="chart/100filmanimasiterbaik.php">100 Film Animasi Terbaik</a></li>
                            </ul>
                        </li>
                        <li><a href="#">Chart</a>
                            <ul>
                                <li><a href="chart/100filmterbaik.php"><img src="cover/film-terbaik-2015-thumbs.png" height="150px" width="200px"></a><br>
                                <a href="chart/100filmterbaik.php"><b>100 Film Terbaik</b></a>
                                </li>
                            </ul>
                        </li>
                        <li><a href="#">Chart</a>
                            <ul>
                                <li><a href="chart/100filmindoterbaik.php"><img src="cover/20170330_carousel_filmnasionalrappler.jpg" height="150px" width="200px"></a><br>
                                <a href="chart/100filmindoterbaik.php"><b>100 Film Indonesia Terbaik</b></a>
                                </li>
                            </ul>
                        </li>
                        <li><a>Chart</a>
                            <ul>
                                <li><a href="#"><img src="photo/best.png" height="150px" width="200px"></a><br>
                                <a href="chart/100filmanimasiterbaik.php"><b>100 Film Animasi Terbaik</b></a>
                                </li>
                                </li>
                            </ul>
                        </li>
                ...
                <?php }else{ ?>
                <li><a href="user.php"><b><?php echo ucfirst(Session::get('nama')); ?></b></a>
                    <ul>
