...
<div id="jenis">
<h3 style="margin-left: 10px;"><b>Akan Datang</b></h3>
<span style="margin-left: 10px;">sort by:<a href="jenis.php?g=<?php echo $genre;?>&urut=Alphabet">Alphabet</a> <a href="jenis.php?g=<?php echo $genre;?>&urut=Rating_skor">Rating Skor</a> <a href="jenis.php?g=<?php echo $genre;?>&urut=tanggal_rilis">Tanggal Rilis</a></span>
   <?php while($d = $profil->fetchObject()):$i++ ?>
 <div class="konten">
  <table >
 	<tr>
 		<td rowspan="4"><img src="profil/<?php echo $d->photo; ?>" width="140px" height="210px"></td>
 		<td width="350px">
	 		<h3 style="margin-left: 10px;"><?php echo $i."."; ?> <a href="tittle.php?m=<?php echo $d->slug; ?>"><?php echo $d->nama; ?></a></h3>
 		</td>
 	</tr>
 	<tr>
 	...
 	<tr>
 		<td ><p style="margin-left: 10px;font-size: 15px;"><?php echo substr($d->tentang, 0,300); ?></p></td>
 	</tr>
  </table>
 </div>
 <?php endwhile; ?>
